...
htmlhelp_basename = 'MyCheminfodoc'
...
latex_documents = [
    (master_doc, 'MyCheminfo.tex', 'MyChem.info Documentation',
     'Su and Wu Labs', 'manual'),
]
...
man_pages = [
    (master_doc, 'mycheminfo', 'MyChem.info Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MyCheminfo', 'MyChem.info Documentation',
     author, 'MyCheminfo', 'One line description of project.',
     'Miscellaneous'),
]

...
file_path_pharma_class = '/Users/kevinxin/Documents/myvariant.info/mychem/data/pharma_class.csv'
#df_drugcentral_pharma_class = pd.read_csv(file_path_pharma_class, sep=",", names=['_id', 'struc_id', 'role', 'description', 'code', 'source'])
file_path_faers = '/Users/kevinxin/Documents/myvariant.info/mychem/data/faers.csv'
...
file_path_act = '/Users/kevinxin/Documents/myvariant.info/mychem/data/act_table_full.csv'
...
file_path_omop = '/Users/kevinxin/Documents/myvariant.info/mychem/data/omop_relationship.csv'
...
file_path_approval = '/Users/kevinxin/Documents/myvariant.info/mychem/data/approval.csv'
#df_drug_approval = pd.read_csv(file_path_approval, sep=",", names=['_id', 'struct_id', 'approval', 'type', 'applicant', 'orphan'])
file_path_synonym = '/Users/kevinxin/Documents/myvariant.info/mychem/data/synonyms.csv'
#df_synonym = pd.read_csv(file_path_synonym, sep=",", names=["_id", "struct_id", 'synonym', 'pref', 'parent', 's2'])
file_path_structure = '/Users/kevinxin/Documents/myvariant.info/mychem/data/structures.smiles.tsv'
#df_structure = pd.read_csv(file_path_structure, sep="\t")
file_path_identifier = '/Users/kevinxin/Documents/myvariant.info/mychem/data/identifiers.csv'
#df_identifier = pd.read_csv(file_path_identifiers, sep=",", names=["_id", "identifier", "id_type", "struct_id", "parent"])
file_path_drug_dosage = '/Users/kevinxin/Documents/myvariant.info/mychem/data/drug_dosage.csv'
